...
import simulator.model.SlowSheep;

public class SlowSheepBuilder extends Builder<Animal>{

private Factory<SelectionStrategy> ssf;
	
	public SlowSheepBuilder(Factory<SelectionStrategy> selection_strategy_factory) {
		super("slow sheep", "I am a slow sheep");
	...
	protected Animal create_instance(JSONObject data) {
		...
		return new SlowSheep(mate_s, danger_s, _pos);
	}
