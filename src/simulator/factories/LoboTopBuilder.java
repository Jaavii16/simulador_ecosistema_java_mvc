...
import simulator.model.LoboTop;
import simulator.model.SelectFirst;
import simulator.model.SelectionStrategy;

public class LoboTopBuilder extends Builder<Animal>{
	
	private Factory<SelectionStrategy> ssf;

	public LoboTopBuilder(Factory<SelectionStrategy> selection_strategy_factory) {
		super("lobo top", "I am a lobo top");
	...
	protected Animal create_instance(JSONObject data) {
		...
		return new LoboTop(mate_s, hunt_s, _pos);
	}
