...
public class MapWindow extends JFrame implements EcoSysObserver {
	...
	private static final long serialVersionUID = -4195543285398794716L;
	...
	public void onRegister(double time, MapInfo map, List<AnimalInfo> animals) {
		check_size_window(time, map, animals);
	}
	...
	private void check_size_window(double time, MapInfo map, List<AnimalInfo> animals) {
